        ...
        SizedBox(width: 24, height: 24, child: Obx(
         ...
         const SizedBox( width: TSizes.spaceBtwItems),
          Text.rich(
            TextSpan(
              children: [
                TextSpan(text: '  ${TTexts.iAgreedTo} ', style: Theme.of(context).textTheme.bodySmall),
                TextSpan(text: TTexts.privecypolicy, style: Theme.of(context).textTheme.bodyMedium!.apply(
