...
class Loader {
  ...
  static hdesnackBar() => ScaffoldMessenger.of(Get.context!).hideCurrentSnackBar();
...
SnackBar(
  ...
  static void successSnackBar({required String title, int duration = 3, required String message}) {
    Get.snackbar(
      title,
      message,
      isDismissible: true,
